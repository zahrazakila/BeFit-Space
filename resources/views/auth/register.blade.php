        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <a href="/" class="flex justify-center">
                <div class="flex items-center space-x-3">
                    <img class="h-10 w-auto rounded-full" src="https://placehold.co/100x100/FFB703/000000?text=B"
                        alt="Be-Fit Space Logo">
                    <span class="text-2xl font-bold text-gray-800 dark:text-[#FFB703]">Be-Fit Space</span>
                </div>
            </a>
